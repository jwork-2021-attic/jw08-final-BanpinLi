...
public class KeyAction {
    ...
    // 复合方向控制
    public static final int WD_ACT = 4;
    public static final int DS_ACT = 5;
    public static final int SA_ACT = 6;
    public static final int AW_ACT = 7;

    // 特殊行为控制
    // 发射远程子弹
    public static final int SHOT = 8;
    public static final int GWD_ACT = 9;
    public static final int GDS_ACT = 10;
    public static final int GSA_ACT = 11;
    public static final int GAW_ACT = 12;
    // 发射近程子弹
